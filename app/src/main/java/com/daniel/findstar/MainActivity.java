...
import com.daniel.findstar.database.StatDatabase;
import com.daniel.findstar.entities.Statistics;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            baseTime = dtf.parse("Mar 07 2023 00:00");
        ...
        star.setOnClickListener(view -> {
            if (starMode) {
                ...
                statistics.setTextColor(getColor(R.color.white));
                for (int i = 0; i < letters.length; i++) {
                ...
                Toast.makeText(this, "Daily games", Toast.LENGTH_SHORT).show();
            } else {
                ...
                Toast.makeText(this, "Unlimited games", Toast.LENGTH_SHORT).show();
            }
            for (int i = 0; i < letters.length; i++) {
                letters[i].setEnabled(true);
                letters[i].setTextColor(getColor(R.color.white));
...
//            });
        ...
        share_btn.setOnClickListener(v -> {
            ...
            String body = "https://play.google.com/store/apps/details?id=com.daniel.findstar";
            myIntent.putExtra(Intent.EXTRA_TEXT, body);
            startActivity(Intent.createChooser(myIntent, "FindStar"));
        });
        ...
        class GetTask extends AsyncTask<Void, Void, List<Statistics>> {
            ...
            protected void onPostExecute(List<Statistics> stats_arr) {
                ...
                Date date = new Date();
                final SimpleDateFormat dtf = new SimpleDateFormat("MMM dd yyyy", Locale.ENGLISH);
                ...
                if (checkWord(word)) {
                    ...
                    if (starMode) {
                        if (!doesExist) {
                            ...
                            Toast.makeText(this, "This word already found", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        if (!doesExist) {
                            word_view.setText(result.trim());
